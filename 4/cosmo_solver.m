...
% W - значение полной электростатической энергии (взаимодействия заряды+заряды и заряды+индуцированные)
% Ws - энергия взаимодействия заряды+индуцированные
% sg - вектор значений поверхностной плотности зарядов в заданных вершинах сетки триангуляции.
